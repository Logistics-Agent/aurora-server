# customer-assistant-service Deployment & Environment Configuration

AI customer chat assistant and automated inquiries handling service (deployed in `aks-ai`).
...
| `GRPC_PORT` | Yes | No | `.env.local` | ConfigMap | `5007` |
