import { CostCalculatorDomainService } from '../../../../src/nestjs/financial-service/src/domain/services/cost-calculator.domain-service';
import { InvoiceDomainService } from '../../../../src/nestjs/billing-service/src/domain/services/invoice.domain-service';
import { NegotiationStrategyDomainService } from '../../../../src/nestjs/negotiation-agent-service/src/domain/services/negotiation-strategy.domain-service';
import { ReadModelStore } from '../../../../src/nestjs/customer-assistant-service/src/read-model/read-model.store';
import { CustomerAssistantService } from '../../../../src/nestjs/customer-assistant-service/src/application/services/assistant.service';

/**
 * AURORA MASTER AUTOMATED TEST SUITE RUNNER
 *
 * Tự động chạy tất cả Test Cases cho 5 Microservices và xuất báo cáo kết quả.
 * Cách chạy: npx ts-node docs/documents/huynh/test/run-all-tests.ts
 */
...
async function runMasterTestSuite() {
  ...
  const mockConfigService = { get: () => 'mock-gemini-api-key' } as any;
