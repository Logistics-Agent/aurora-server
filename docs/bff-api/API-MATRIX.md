...
| `POST` | `/api/v1/notifications/devices` | Register FCM Device | `notifications:access` | `true` | `Notification` | `RegisterDevice` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `DELETE` | `/api/v1/notifications/devices/{id}` | Deactivate FCM Device | `notifications:access` | `true` | `Notification` | `RemoveDevice` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `POST` | `/api/v1/notifications/subscriptions/shipments/{shipmentId}` | Subscribe Shipment Notifications | `notifications:access` | `true` | `Notification` | `SubscribeShipment` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `GET` | `/api/v1/notifications` | List User Notifications | `notifications:access` | `true` | `Notification` | `ListNotifications` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `GET` | `/api/v1/notifications/unread-count` | Get Unread Notification Count | `notifications:access` | `true` | `Notification` | `GetUnreadCount` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `PATCH` | `/api/v1/notifications/{id}/read` | Mark Notification As Read | `notifications:access` | `true` | `Notification` | `MarkNotificationRead` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
| `PATCH` | `/api/v1/notifications/read-all` | Mark All Notifications Read | `notifications:access` | `true` | `Notification` | `MarkAllNotificationsRead` | `Staff.Bff/Controllers/NotificationsController.cs` | `notification.proto`, `NotificationDbContext` | `IMPLEMENTED` |
