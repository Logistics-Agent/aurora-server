...
| **Staff.Bff** | **Notification** | `NotificationService` | `ListNotifications`, `MarkNotificationRead`, `ListNotificationPreferences`, `UpsertNotificationPreference` | `protos/notification.proto` | **VERIFIED** | `x-tenant-id`, `x-user-id` |
